(() => {
  ...
  const techIconPaths = {
    ...
    cpp: '<path d="M32 4 55 17v30L32 60 9 47V17L32 4Z" fill="none" stroke="currentColor" stroke-width="3"/><text x="32" y="38" text-anchor="middle" fill="currentColor" font-size="16" font-weight="800" font-family="Arial,sans-serif">C++</text>',
    html: '<path d="M11 7h42l-4 46-17 5-17-5L11 7Z" fill="none" stroke="currentColor" stroke-width="3"/><path d="M21 20h23l-1 9H24l1 10 8 2 7-2 .6-6" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"/>',
    css: '<path d="M11 7h42l-4 46-17 5-17-5L11 7Z" fill="none" stroke="currentColor" stroke-width="3"/><path d="M22 20h22l-1 8-18 7h17l-1 9-9 3-9-3" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"/>',
    ...
    sql: '<ellipse cx="32" cy="14" rx="21" ry="8" fill="none" stroke="currentColor" stroke-width="3"/><path d="M11 14v36c0 4.4 9.4 8 21 8s21-3.6 21-8V14M11 32c0 4.4 9.4 8 21 8s21-3.6 21-8" fill="none" stroke="currentColor" stroke-width="3"/><text x="32" y="39" text-anchor="middle" fill="currentColor" font-size="10" font-weight="800">SQL</text>',
    visualstudio: '<path d="m8 19 10-8 15 13L49 9l7 4v38l-7 4-16-15-15 13-10-8 13-13L8 19Zm25 5v16l16 9V15l-16 9Z" fill="currentColor"/>',
    vscode: '<path d="m47 6 10 5v42l-10 5-26-20-10 8-5-4V22l5-4 10 8L47 6Zm0 14L29 32l18 12V20ZM12 24v16l9-8-9-8Z" fill="currentColor"/>',
    git: '<path d="m32 5 27 27-27 27L5 32 32 5Z" fill="currentColor"/><path d="M22 22l20 20M22 22h13v13" fill="none" stroke="#071120" stroke-width="4" stroke-linecap="round"/><circle cx="22" cy="22" r="4" fill="#071120"/><circle cx="42" cy="42" r="4" fill="#071120"/><circle cx="35" cy="35" r="4" fill="#071120"/>',
    ssms: '<ellipse cx="27" cy="15" rx="18" ry="7" fill="none" stroke="currentColor" stroke-width="3"/><path d="M9 15v31c0 4 8 7 18 7s18-3 18-7V15M9 30c0 4 8 7 18 7s18-3 18-7" fill="none" stroke="currentColor" stroke-width="3"/><path d="M43 38h14v18H43zM46 42h8M46 47h8M46 52h5" fill="none" stroke="currentColor" stroke-width="2.5"/>',
    office: '<path d="M14 13 36 5l15 6v42l-15 6-22-8V13Zm22 2-13 4v26l13 4V15Zm0 0 10-2v38l-10-2" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"/>',
    googleworkspace: '<path d="M12 18 32 6l20 12v28L32 58 12 46V18Z" fill="none" stroke="currentColor" stroke-width="4"/><path d="M12 18h40M12 46h40M32 6v52" fill="none" stroke="currentColor" stroke-width="3"/>',
    team: '<circle cx="24" cy="23" r="8" fill="none" stroke="currentColor" stroke-width="3"/><circle cx="44" cy="25" r="6" fill="none" stroke="currentColor" stroke-width="3"/><path d="M9 53c1-11 7-17 15-17s14 6 15 17M38 39c8 0 13 5 14 14" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"/>',
    frontend: '<rect x="7" y="10" width="50" height="44" rx="5" fill="none" stroke="currentColor" stroke-width="3"/><path d="M7 21h50M15 16h1M22 16h1M29 16h1M18 31l-6 6 6 6M46 31l6 6-6 6M37 28l-9 18" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>',
